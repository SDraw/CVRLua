...
namespace CVRLua.Lua.LuaDefs
{
    static class NavMeshHitDefs
    {
        ...
        {
            ms_staticMethods.Add((nameof(IsNavMeshHit), IsNavMeshHit));
        ...
        {
            p_vm.RegisterClass(typeof(Wrappers.NavMeshHit), Create, null, ms_staticMethods, ms_metaMethods, ms_instanceProperties, null);
        }

...
namespace CVRLua.Lua.LuaDefs
{
    static class NavMeshPathDefs
    {
        ...
        {
            p_vm.RegisterClass(typeof(NavMeshPath), Create, null, null, ms_metaMethods, ms_instanceProperties, ms_instanceMethods);
            p_vm.RegisterFunction(nameof(IsNavMeshPath), IsNavMeshPath);
        }
